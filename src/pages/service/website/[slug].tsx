              ...
              <div className='row g-lg-5 h-100 align-items-center'>
                <div className='col-12 col-sm-10 col-md-6'>
                  ...
                  <div className='welcome-content'>
                    <ul
                      className='mb-lg-3 d-flex align-items-center wow fadeInUp mb-2 ps-0'
                    ...
                    <p
                      className='text-white-50 wow fadeInUp mb-5'
                      data-wow-duration='1000ms'
            ...
            <div className='row justify-content-center'>
              <div className='col-12 col-sm-9 col-md-8 col-lg-7'>
                <div className='section-heading text-center'>
                  ...
                  <p>
                    Kami menyediakan beberapa pilihan paket{' '}
                    {props.foundItem.name} yang kami susun sesuai dengan
                    kebutuhan Anda.
                  </p>
                </div>
              </div>
              ...
              <div className='col-12'>
                <div className='row g-4 justify-content-center'>
                  ...
                  <div className='col-12 col-sm-9 col-md-7 col-lg-3'>
                    <div
                      className='card pricing-card monthly-plan wow fadeInUp shadow-lg'
                      data-wow-duration='1000ms'
                      data-wow-delay='300ms'
                    >
                      <h3>Lite</h3>
                      <div className='pricing-heading mb-3'>
                        <div className='price'>
                          <div className='price-quantity'>
                            <h2 className='monthly-price mb-0'>2.000k</h2>
                          </div>
                        </div>
                      </div>
                      <div className='pricing-desc mb-5'>
                        <ul className='list-unstyled mb-0'>
                          ...
                          <li>
                            <i className='text-danger bi bi-x-circle-fill me-2' />
                            Proteksi Keamanan
                          </li>
                          <li>
                            <i className='text-info bi bi-check-circle-fill me-2' />
                  ...
                  <div className='col-12 col-sm-9 col-md-7 col-lg-3'>
                    ...
                    >
                      ...
                      <div className='pricing-heading mb-3'>
                        <div className='price'>
                          <div className='price-quantity'>
                            <h2 className='monthly-price mb-0'>3.000k</h2>
                          </div>
                        </div>
                      </div>
                      <div className='pricing-desc mb-5'>
                  ...
                  <div className='col-12 col-sm-9 col-md-7 col-lg-3'>
                    <div
                      className='card pricing-card monthly-plan active bg-img wow fadeInUp shadow-lg'
                    ...
                    >
                      ...
                      <div className='pricing-heading mb-3'>
                        <div className='price'>
                          <div className='price-quantity'>
                            <h2 className='monthly-price mb-0'>4.000k</h2>
                          </div>
                        </div>
                      </div>
                      <div className='pricing-desc mb-5'>
                  ...
                  <div className='col-12 col-sm-9 col-md-7 col-lg-3'>
                    ...
                    >
                      ...
                      <div className='pricing-heading mb-3'>
                        <div className='price'>
                          <div className='price-quantity'>
                            <h2 className='monthly-price mb-0'>7.000k</h2>
                          </div>
                        </div>
                      </div>
                      <div className='pricing-desc mb-5'>
                  ...
                  <div className='section-heading'>
                    <div className='section-heading mt-5'>
                      <h2 className='text-center'>
                        Pilihan Tema {props.foundItem.name}
                      </h2>
                    </div>
                    ...
                    <div className='row'>
                      {props.foundItem.themes.map((theme: any) => (
                        <div className='col-12 col-sm-6 pb-4' key={theme.id}>
                          <Link
                            href={`/theme/${props.foundItem.slug}/${theme.slug}`}
                          >
                            <Image
                              src={theme.image}
                              className='shadow-lg'
              ...
              <div className='col-12 col-sm-9 col-lg-8'>
                <div className='section-heading text-center'>
                  ...
                  <p className='text-dark'>
                    Anda akan mendapatkan berbagai feature dan fasilitas lengkap
          ...
          <div className='container'>
            <div className='row g-4 g-xxl-5'>
              <div className='col-12 col-sm-6 col-lg-4'>
                <div
                  className='card feature2-card wow fadeInUp shadow-lg'
                  data-wow-duration='1000ms'
                ...
                >
                  <div className='card-body'>
                    ...
                    <p>
                      Tampilan desain menyesuaikan dengan karakteristik
                      perusahaan serta Brand yang dimiliki. Anda bebas
                      menentukan tata letak, warna dan susunan kata
                    </p>
                  </div>
                </div>
              </div>
              <div className='col-12 col-sm-6 col-lg-4'>
                ...
                >
                  <div className='card-body'>
                    ...
                    <p>
                      80% website diakses menggunakan perangkat mobile, dan
                      tampilan website Anda akan tetap responsive, nyaman, tanpa
              ...
              <div className='col-12 col-sm-6 col-lg-4'>
                ...
                >
                  <div className='card-body'>
                    ...
                    <p>
                      Designer dan developer kami didominasi oleh anak muda yang
                      memiliki ide design yang fresh dan modern yang mengikuti
                      perkembangan zaman.
                    </p>
                  </div>
                </div>
              ...
              <div className='col-12 col-sm-6 col-lg-4'>
                ...
                >
                  <div className='card-body'>
                    <h5>Optimasi SEO</h5>
                    <p>
                      Kami optimalkan seluruh elemen yang ada di website
                      perusahaan Anda agar sesuai dengan algoritma Google
                      terbaru dan bisa bersaing di top Google
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className='col-12 col-sm-6 col-lg-4'>
                ...
                >
                  <div className='card-body'>
                    ...
                    <p>
                      Server menggunakan teknologi terbaru saat ini sehingga
                      menjamin website tetap online untuk memaksimalkan
                      informasi agar tetap bisa diakses
                    </p>
                  </div>
                </div>
              </div>
              <div className='col-12 col-sm-6 col-lg-4'>
                ...
                >
                  <div className='card-body'>
                    ...
                    <p>
                      Seluruh proses pengerjaan akan kami update, dan kami ajak
                      Anda untuk berpartisipasi dalam proses revisi atau
                      perbaikan agar hasil sesuai ekspektasi
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className='col-12 col-sm-6 col-lg-4'>
                ...
                >
                  <div className='card-body'>
                    ...
                    <p>
                      Kami memberikan space hosting yang cukup leluasa untuk
                      bisa menambahkan banyak konten seperti artikel, image,
                      blog serta kami berikan space leluasa untuk email yang
                      leluasa.
                    </p>
                  </div>
                </div>
        ...
        <div className='breadcrumb-wrapper breadcrumb-bg-light'>
          <div className='h-100 container'>
            <div className='row h-100 align-items-center'>
              <div className='col-12'>
                <div className='section-heading mb-0 text-center'>
                  <h6>FAQ</h6>
                  ...
                  <div className='accordion faq--accordian' id='faqaccordian'>
                    ...
                    <div className='card border-0'>
                      ...
                      >
                        <div className='card-body'>
                          <p>
                            Ya, semua paket jasa web perusahaan kami diatas
                            sudah termasuk domain + hosting. Jadi anda tidak
                            perlu biaya tambahan lagi untuk membayar biaya
                            domain dan hosting, serta tidak perlu repot untuk
                            mengelola hosting.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className='card border-0'>
                      ...
                      >
                        <div className='card-body'>
                          <p>
                            Semua pembayaran full payment kecuali untuk paket
                            Medium dan PRO, maka ada 2 opsi yaitu:
                          </p>
                          <ol>
                            <li>Full Payment</li>
                            <li>
                              DP 50% dan kekurangannya silahkan ditransfer
                              setelah website dinyatakan telah selesai.
                            </li>
                          </ol>
                        </div>
                      </div>
                    ...
                    <div className='card border-0'>
                      ...
                      >
                        <div className='card-body'>
                          <p>
                            Ya, berlaku jika Anda menginginkan beberapa
                            fitur-fitur custom pada website profesional untuk
                            menyesuaikan kebutuhan bisnis Anda maka dikenakan
                            biaya tambahan bedasarkan kesepakatan. Selengkapnya
                            Anda dapat menghubungi Customer Care Ditrois.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className='accordion faq--accordian' id='faqaccordian2'>
                    ...
                    <div className='card border-0'>
                      ...
                      >
                        <div className='card-body'>
                          <p>
                            Ya, kami telah mengerjakan berbagai bermacam website
                            sesuai dengan permintaan klien. Jika Anda ingin
                            memiliki website profesional sesuai keinginan atau
                            website custom seperti toko online, marketplace,
                            portal berita, web rumah sakit dan lain-lain,
                            Selengkapnya Anda dapat menghubungi Customer Care
                            Ditrois.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className='card border-0'>
                      <div className='card-header' id='headingFive'>
                        ...
                        >
                          Apakah saya dapat mengintegrasikan media sosial dalam
                          website saya?
                        </button>
                      </div>
                      <div
                      ...
                      >
                        <div className='card-body'>
                          <p>
                            Ya, Anda dapat mengintegrasikan media sosial seperti
                            Facebook, Instagram, Twitter, atau LinkedIn ke dalam
                            website Anda
                          </p>
                        </div>
                      </div>
                    ...
                    <div className='card border-0'>
                      <div className='card-header' id='headingSix'>
                        ...
                        >
                          Bagaimana dengan pemeliharaan dan pembaruan website
                      ...
                      >
                        <div className='card-body'>
                          <p>
                            Ditrois memberikan penawaran layanan pemeliharaan,
                            pembaruan website, mengelola konten website sebagai
                            opsi tambahan, silahkan untuk menghubungi Customer
                            Care Ditrois. Anda dapat mempercayakan tugas
                            tersebut kepada tim Ditrois untuk memastikan website
                            Anda tetap aman, terbarui, dan berfungsi optimal.
                          </p>
                        </div>
                      </div>
                    </div>
...
export async function getStaticProps(context: any) {
  ...
  const foundItem = localData.services.websites.find(
    (item: any) => itemSlug === item.slug
  );
